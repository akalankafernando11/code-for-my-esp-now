...
//......................................write text file ............................//
if(FileSize == massageLenth){//01
//delay(100);
 File outfile = SPIFFS.open("/Image.txt",FILE_WRITE);
           if(!outfile){
               Serial.println("Error: opening file");
               return;
           }
                 if(outfile.print(esp_now_incoming_message1)){
...
//Serial.println(buf);
String sqlite3_return = String(buf);
for(int k=1; k<=324; k++)
{ 
    int no1 = (k*150);
    String sqlite = sqlite3_return.substring(no1,no1-150);
   // sqlite3_return_string.remove(0, 150);
   Serial.print(k);
   Serial.print("\t");
    Serial.println(sqlite);
}
file.close(); 
